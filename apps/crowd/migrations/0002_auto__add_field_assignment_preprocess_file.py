...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.preprocess_file'
        db.add_column('crowd_assignment', 'preprocess_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.preprocess_file'
        db.delete_column('crowd_assignment', 'preprocess_file')
    ...
    models = {
        ...
        'crowd.assignment': {
            ...
            'preprocess_file': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True'}),
