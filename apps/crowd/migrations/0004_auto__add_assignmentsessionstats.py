...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssignmentSessionStats'
        db.create_table('crowd_assignmentsessionstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment_session', self.gf('django.db.models.fields.related.OneToOneField')(related_name='stats', unique=True, to=orm['crowd.AssignmentSession'])),
            ('mileage', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('accuracy', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=5)),
        ))
        db.send_create_signal('crowd', ['AssignmentSessionStats'])


    def backwards(self, orm):
        # Deleting model 'AssignmentSessionStats'
        db.delete_table('crowd_assignmentsessionstats')
