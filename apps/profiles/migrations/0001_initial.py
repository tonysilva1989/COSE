...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_userprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, primary_key=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('profiles', ['UserProfile'])

        # Adding model 'RequesterProfile'
        db.create_table('profiles_requesterprofile', (
            ...
            ('account_balance', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('profiles', ['RequesterProfile'])

        # Adding model 'WorkerProfile'
        db.create_table('profiles_workerprofile', (
            ('userprofile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['profiles.UserProfile'], unique=True, primary_key=True)),
            ('score', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('profiles', ['WorkerProfile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_requesterprofile')

        # Deleting model 'WorkerProfile'
        db.delete_table('profiles_workerprofile')
